...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 24 mai 2025 à 15:13
...
INSERT INTO `commande` (`id_commande`, `id_user_commande`, `statut`, `date_commande`, `promo_id`) VALUES
(1, 4, 'Envoye', '2025-04-14 17:12:12', 0),
(2, 1, 'En attente', '2025-05-24 12:46:24', 10),
(3, 1, 'En attente', '2025-04-15 07:48:19', 0),
(4, 4, 'En attente', '2025-05-24 13:10:51', 10),
(5, 13, 'En attente', '2025-05-19 12:08:35', NULL);
...
INSERT INTO `products` (`id_produit`, `user_id`, `title`, `description`, `price`, `quantite`, `image`, `category`, `created_at`, `actif`, `valide`, `refuse`, `comm_refu`, `marque`) VALUES
(1, 4, 'gundam', 'maket de 200 pieces', 50.00, 0, '../img/imgProduct/produit1.png', '1', '2025-01-27 15:12:03', 1, 1, 0, '', 'BANDAI'),
(3, 4, 'souris', 'souris gaming extra light', 12.00, 0, '../img/imgProduct/produit2.png', '2', '2025-02-27 17:52:00', 1, 1, 0, '', ''),
(4, 1, 'Cookbook', 'Livre de cuisine gastro par le grand chef Clarisse', 37.52, 50, NULL, '1', '2025-03-02 08:46:45', 1, 0, 0, '', 'BANDAI'),
...
(17, 4, 'Tour gaming', 'Super set up pour des soiree gamin entre pote avec la nouvelle 4080 et t pas le seul a la vouloir donc ne trainne pas', 1200.78, 25, '', '3', '2025-03-06 16:43:55', 1, 0, 0, '', ''),
...
(11, 'SUPERCODE2025', 'Super code 2025', 'Utilisable sur toute la marketplace', '2025-04-01', '2025-12-31', 5.00, '', 15000.00, 0.00, 1, 0, 1, 1, 1, 1, '2025-04-12 19:47:18', '2025-05-19 12:30:43', 100),
...
(4, 4, 3, 5, 'Ptn de souris gaming de fou v'),
(6, 4, 20, 5, 'super produit test');
...
(6, 'SUPERPAUL', 'PAUL', 'paul@gmail.com', 0, '$2y$10$kcMiWEjLK.squCRYTgugYO3qCdRtxnUkloHKmf/1Dr91EyAw6g1tW', '../img/imgUserProfil/defaultPP.png', '', 0, '', '', 'Acheteur', 0, 0),
(7, 'Clarisse', 'Binard', 'Clarisse@gmail.com', 0, '$2y$10$Kn5TvLV/PYmVYc0Fy.0Dpemzar25YNjGxnDGk0kDBISCoz4KO2R5y', '../img/imgUserProfil/defaultPP.png', '', 0, '', '', 'Acheteur', 0, 0),
(9, 'akjbebcoze', 'aqefcoazbpecf', 'azivcuze@czev.com', 0, '$2y$10$2YFyveDJgrHhgetn1O4kz.zjL4UMCNuNwNarbvTFy721v59CPPwMW', '../img/imgUserProfil/defaultPP.png', '', 0, '', '', 'Acheteur', 0, 0),
(12, 'Zzjbfiozve', 'Lathuy', 'zhjvzie@osznvnoez.com', 0, '$2y$10$aPErXKsUWELabziQIxoJ6O.f84mdaJvqhXgtzj16As.2cwYsV0jRK', '../img/imgUserProfil/defaultPP.png', '', 0, '', '', 'Acheteur', 0, 0),
(13, 'phil', 'Lathuy', 'zuvzoev@pzinve.com', 478365547, '$2y$10$UdXxvb.gEJWiIHsHLG0lX.jYukKxE/PPtELiyHwg9WrSi.9XHPqMa', '../img/imgUserProfil/defaultPP.png', 'Rue du Tombois', 22, '5650', 'pry', 'Acheteur', 0, 0);
...
--
ALTER TABLE `panier`
  MODIFY `id_panier` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
